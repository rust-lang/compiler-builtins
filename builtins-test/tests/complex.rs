    ...
    fn test_mul<F: Float>(p: Complex<F>, q: Complex<F>, actual: Complex<F>, tolerance: F) -> bool {
        match classify(p) {
            Class::Zero => match classify(q) {
                Class::Zero | Class::NonZero => {
                    if classify(actual) != Class::Zero {
                        return true;
                    }
                }
                Class::Infinite | Class::NaN | Class::NonZeroAndNaN => {
                    if classify(actual) != Class::NaN {
                        return true;
                    }
                }
            },
            ...
            Class::NonZero => match classify(q) {
                ...
                Class::Infinite => {
                    if classify(actual) != Class::Infinite {
                        return true;
                    }
                }
                Class::NaN | Class::NonZeroAndNaN => {
                    if classify(actual) != Class::NaN {
                        return true;
                    }
                }
            ...
            Class::Infinite => match classify(q) {
                ...
                Class::NonZero | Class::Infinite | Class::NonZeroAndNaN => {
                    if classify(actual) != Class::Infinite {
                        return true;
                    }
                }
            ...
            Class::NonZeroAndNaN => match classify(q) {
                ...
                Class::Zero | Class::NonZero | Class::NaN | Class::NonZeroAndNaN => {
                    if classify(actual) != Class::NaN {
                        return true;
                    }
                }
    ...
    fn test_div<F: Float>(
        ...
        match classify(dividend) {
            ...
            Class::NonZeroAndNaN => match classify(divisor) {
                ...
                Class::NonZero | Class::Infinite | Class::NaN | Class::NonZeroAndNaN => {
                    if classify(actual) != Class::NaN {
                        return true;
                    }
                }
