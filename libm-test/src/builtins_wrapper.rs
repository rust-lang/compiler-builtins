...
cb_op!(@binop f128, add, __addkf3, addf128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(@binop f128, sub, __subkf3, subf128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(@binop f128, mul, __mulkf3, mulf128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(@binop f128, div, __divkf3, divf128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(pow, __powikf2, powif128, (a: f128, b: i32) -> f128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(@cmp_eq f128, cmp, __eqkf2, eqf128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(@cmp_gt f128, cmp, __gtkf2, gtf128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(@cmp_ge f128, cmp, __gekf2, gef128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(@cmp_lt f128, cmp, __ltkf2, ltf128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(@cmp_le f128, cmp, __lekf2, lef128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(@cmp_ne f128, cmp, __nekf2, nef128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(@cmp_unord f128, cmp, __unordkf2, unordf128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(extend, __extendhfkf2, extend_f16_f128, (a: f16) -> f128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(extend, __extendsfkf2, extend_f32_f128, (a: f32) -> f128);
#[cfg(f128_enabled)]
#[cfg(not(any(target_arch = "powerpc", target_arch = "powerpc64")))]
cb_op!(extend, __extenddftf2, extend_f64_f128, (a: f64) -> f128);
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(extend, __extenddfkf2, extend_f64_f128, (a: f64) -> f128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(trunc, __trunckfhf2, narrow_f128_f16, (a: f128) -> f16);
#[cfg(f128_enabled)]
#[cfg(not(any(target_arch = "powerpc", target_arch = "powerpc64")))]
cb_op!(trunc, __trunctfsf2, narrow_f128_f32, (a: f128) -> f32);
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(trunc, __trunckfsf2, narrow_f128_f32, (a: f128) -> f32);
#[cfg(f128_enabled)]
#[cfg(not(any(target_arch = "powerpc", target_arch = "powerpc64")))]
cb_op!(trunc, __trunctfdf2, narrow_f128_f64, (a: f128) -> f64);
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(trunc, __trunckfdf2, narrow_f128_f64, (a: f128) -> f64);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(conv, __fixkfsi, ftoi_f128_i32, (a: f128) -> i32);
#[cfg(f128_enabled)]
#[cfg(not(any(target_arch = "powerpc", target_arch = "powerpc64")))]
cb_op!(conv, __fixtfdi, ftoi_f128_i64, (a: f128) -> i64);
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(conv, __fixkfdi, ftoi_f128_i64, (a: f128) -> i64);
#[cfg(f128_enabled)]
#[cfg(not(any(target_arch = "powerpc", target_arch = "powerpc64")))]
cb_op!(conv, __fixtfti, ftoi_f128_i128, (a: f128) -> i128);
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(conv, __fixkfti, ftoi_f128_i128, (a: f128) -> i128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(conv, __fixunskfsi, ftoi_f128_u32, (a: f128) -> u32);
#[cfg(f128_enabled)]
#[cfg(not(any(target_arch = "powerpc", target_arch = "powerpc64")))]
cb_op!(conv, __fixunstfdi, ftoi_f128_u64, (a: f128) -> u64);
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(conv, __fixunskfdi, ftoi_f128_u64, (a: f128) -> u64);
#[cfg(f128_enabled)]
#[cfg(not(any(target_arch = "powerpc", target_arch = "powerpc64")))]
cb_op!(conv, __fixunstfti, ftoi_f128_u128, (a: f128) -> u128);
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(conv, __fixunskfti, ftoi_f128_u128, (a: f128) -> u128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(conv, __floatsikf, itof_i32_f128, (a: i32) -> f128);
#[cfg(f128_enabled)]
#[cfg(not(any(target_arch = "powerpc", target_arch = "powerpc64")))]
cb_op!(conv, __floatditf, itof_i64_f128, (a: i64) -> f128);
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(conv, __floatdikf, itof_i64_f128, (a: i64) -> f128);
#[cfg(f128_enabled)]
#[cfg(not(any(target_arch = "powerpc", target_arch = "powerpc64")))]
cb_op!(conv, __floattitf, itof_i128_f128, (a: i128) -> f128);
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(conv, __floattikf, itof_i128_f128, (a: i128) -> f128);
...
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(conv, __floatunsikf, itof_u32_f128, (a: u32) -> f128);
#[cfg(f128_enabled)]
#[cfg(not(any(target_arch = "powerpc", target_arch = "powerpc64")))]
cb_op!(conv, __floatunditf, itof_u64_f128, (a: u64) -> f128);
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(conv, __floatundikf, itof_u64_f128, (a: u64) -> f128);
#[cfg(f128_enabled)]
#[cfg(not(any(target_arch = "powerpc", target_arch = "powerpc64")))]
cb_op!(conv, __floatuntitf, itof_u128_f128, (a: u128) -> f128);
#[cfg(f128_enabled)]
#[cfg(any(target_arch = "powerpc", target_arch = "powerpc64"))]
cb_op!(conv, __floatuntikf, itof_u128_f128, (a: u128) -> f128);
